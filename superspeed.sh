...
if [[ ${selection} == 6 ]]; then
	...
	start=$(date +%s) 
	 ...
	 speed_test '14903' 'CSL' '香港大埔'
	 speed_test '13538' 'CSL' '葵涌, 香港'
	 speed_test '16176' 'HGC Global Communications Limited' '香港沙田'
	 speed_test '17130' 'Telin' '香港'
	 speed_test '10267' 'Interoute VDC' '香港'
	 speed_test '22126' 'i3D.net' '香港'
	 speed_test '21182' 'Gemnet LLC' '香港'
	 speed_test '12990' 'QTS 数据中心' '香港'
	 speed_test '19036' 'SmarTone' '香港'
	 speed_test '18745' 'FPT Telecom' '香港'
